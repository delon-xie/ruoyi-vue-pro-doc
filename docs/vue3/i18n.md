...
查看代码 import { defineStore } from 'pinia'
...
1. 在 [types/global.d.ts (opens new window)](https://github.com/yudaocode/yudao-ui-admin-vue3/blob/master/types/global.d.ts#L15) 给 `LocaleType` 添加对应的类型
1. 在 [src/store/modules/locale.ts (opens new window)](https://github.com/yudaocode/yudao-ui-admin-vue3/blob/master/src/store/modules/locale.ts#L26-L38) `localeMap` 中添加对应语言
## # 8. 远程读取语言数据
...
[CRUD 组件](/vue3/crud-schema/) [IDE 调试](/vue3/debugger/) 
←
[CRUD 组件](/vue3/crud-schema/) [IDE 调试](/vue3/debugger/)→
