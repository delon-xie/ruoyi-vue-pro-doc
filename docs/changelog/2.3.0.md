...
- 【修复】修复抖音小程序无法启动问题，由 [@heStudio_admin (opens new window)](https://gitee.com/heStudio_admin) 贡献 [#67 (opens new window)](https://gitee.com/yudaocode/yudao-mall-uniapp/pulls/67/)
