...
### # 🐞 Bug Fixes
- 【修复】菜单搜索点击输入框会折叠问题，由 [@半栈幼儿员 (opens new window)](https://gitee.com/preschooler) 贡献 [#562 (opens new window)](https://gitee.com/yudaocode/yudao-ui-admin-vue3/pulls/562/)
