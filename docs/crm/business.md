...
![商机转换](../images/img_cffc8945.png) 一个商机，通常需要经过一系列的销售阶段，如挖掘、资格验证、需求分析、价值评估等，最后才能成为一笔实际的交易。因此，整体的表结构如下：
![表关系](../images/img_0b2f6003.png) 商机模块，由 `yudao-module-crm` 后端模块的 `business` 包实现，包括两个部分：商机信息、商机状态配置。
## # 1. 商机状态
...
![商机状态配置](../images/img_98281526.png) 点击【新增】按钮，可以新增商机状态组，如下图所示：
![新增商机状态组](../images/img_b2a1c77b.png) 
## # 2. 商机
...
![商机管理](../images/img_4c3530db.png) ① 点击【新增】按钮，随便填写一些信息，点击「确认」按钮，即可新增一条商机。如下图所示：
![新增商机](../images/img_48ddd5b5.png) ② 点击“商机名称”，进入商机详情页，可以查看商机的详细信息，如下图所示：
![商机详情](../images/img_84c5ac09.png) ③ 点击【变更商机状态】按钮，可以变更商机的状态，如下图所示：
![变更商机状态](../images/img_5744abd9.png) 可以多次变更，直到 `end_status` 字段有值，即商机结束，即“赢单”、“输单”、“无效”三种。
## # 3. 联系人与商机的关联
...
![联系人关联的商机](../images/img_566a01b1.png) 
