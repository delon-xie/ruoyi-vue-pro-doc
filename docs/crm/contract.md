...
合同模块，由 `yudao-module-crm` 后端模块的 `contract` 包实现，已经和 [BPM 工作流](/bpm/) 打通审批。
## # 1. 合同
...
![合同管理](../images/img_48af05e1.png) ① 点击【新增】按钮，随便填写一些信息，点击「确认」按钮，即可新增一条合同。如下图所示：
![新增合同](../images/img_7b0a9541.png) ② 点击【提交审批】按钮，可以提交审批。如下图所示：
![提交审批](../images/img_8a664a07.png) 友情提示：
...
![查看审批](../images/img_86170f6d.png) 点击审批【通过】按钮，将合同审批通过，此时它会回调 CrmContractResultListener 监听器，更新合同的 `audit_status` 字段为审批通过。如下图所示：
![审批通过](../images/img_a62fcba1.png) ③ 点击“合同名称”，进入合同详情页，可以查看合同的详细信息，如下图所示：
![合同详情](../images/img_6ea76619.png) 
## # 2. 合同配置
...
![即将到期的合同](../images/img_cdde2f0a.png) 
### # 2.2 管理后台
