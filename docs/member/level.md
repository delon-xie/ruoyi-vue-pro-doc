...
![管理后台](../images/img_e700c520.png) ② 会员详情的 [成长值] 标签，可以查看 `member_experience_record` 表的记录，对应 `views/member/user/detail/UserExperienceRecordList.vue` 组件。如下图所示：
![会员详情 - 成长值](../images/img_067a68db.png) 
### # 1.3 移动端
...
![管理后台](../images/img_27f5b80e.png) ② 会员详情的 [积分] 标签，可以查看 `member_point_record` 表的记录，对应 `views/member/user/detail/UserPointList.vue` 组件。如下图所示：
![会员详情 - 积分](../images/img_a9dd3ab9.png) 
### # 2.3 移动端
点击 uni-app 底部的 [我的] 导航，点击 [积分] 菜单，进入积分信息界面，对应 `yudao-mall-uniapp` 项目的 `pages/user/wallet/score.vue` 页面。如下图所示：
![移动端](../images/img_5a9eeb5b.png) 
## # 3. 会员签到
会员签到，通过每日签到，获得积分、经验等奖励。
它的后端由 `signin` 包实现，表关系如下图所示：
![表关系](../images/img_0e628793.png) 
### # 3.1 表结构
...
![管理后台 - 签到配置](../images/img_10042b79.png) ② 对应 [会员系统 -> 会员中心 -> 会员签到 -> 签到记录] 菜单，对应 `yudao-ui-admin-vue3` 项目的 `views/member/signin/record` 目录。如下图所示：
![管理后台 - 签到记录](../images/img_71adbbdc.png) ③ 会员详情的 [签到] 标签，可以查看 `member_sign_in_record` 表的记录，对应 `views/member/user/detail/UserSignList.vue` 组件。如下图所示：
![会员详情 - 签到](../images/img_51dfb244.png) 
### # 3.3 移动端
点击 uni-app 底部的 [我的] 导航，点击 [签到] 菜单，进入签到界面，对应 `yudao-mall-uniapp` 项目的 `pages/app/sign.vue` 页面。如下图所示：
![移动端](../images/img_99183d27.png) 
.pageB img{width:80px!important;}
.wwads-horizontal .wwads-text, .wwads-content .wwads-text{line-height:1;}
[会员用户、标签、分组](/member/user/) [商城演示](/mall-preview/) 
←
[会员用户、标签、分组](/member/user/) [商城演示](/mall-preview/)→
