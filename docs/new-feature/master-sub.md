...
![生成信息 - 课程](../images/img_b4de1981.png) 
...
![生成信息 - 班级](../images/img_89dec38b.png) 
...
[代码生成【单表】（新增功能）](/new-feature/) [代码生成（树表）](/new-feature/tree/) 
←
[代码生成【单表】（新增功能）](/new-feature/) [代码生成（树表）](/new-feature/tree/)→
