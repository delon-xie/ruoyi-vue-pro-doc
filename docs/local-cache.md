...
![调用 RoleProducer 示例](/images/03.png) 
#### # 2.2.3 RoleRefreshConsumer
新建 RoleRefreshConsumer 类，RoleRefreshMessage 的 Consumer 消费者，刷新本地缓存。代码如下：
@Component
@Slf4j
public class RoleRefreshConsumer extends AbstractRedisChannelMessageListener {
@Resource
...
[Redis 缓存](/redis-cache/) [异步任务](/async-task/) 
←
[Redis 缓存](/redis-cache/) [异步任务](/async-task/)→
