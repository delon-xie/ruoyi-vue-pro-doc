...
由 [@lijiahui-jerry (opens new window)](https://gitee.com/lijiahui-jerry) 贡献：[#1529 (opens new window)](https://gitee.com/zhijiantianya/ruoyi-vue-pro/pulls/1529)（后端）、[#869 (opens new window)](https://gitee.com/yudaocode/yudao-ui-admin-vue3/pulls/869)（前端）
