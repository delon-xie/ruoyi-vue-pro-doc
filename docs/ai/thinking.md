...
② Anthropic：应该已经支持，待 Spring AI 发新版本，可见 [https://github.com/spring-projects/spring-ai/pull/2800](https://github.com/spring-projects/spring-ai/pull/2800) 讨论。
③ Gemini：官方没提供合适的 SDK，目前项目是通过 OpenAI 的客户端接入，等待 Spring AI 官方吧~
④ Ollama：返回了 `thinking` 标签，看看后续的演进吧！可见 [https://github.com/spring-projects/spring-ai/pull/3386](https://github.com/spring-projects/spring-ai/pull/3386) 讨论。
