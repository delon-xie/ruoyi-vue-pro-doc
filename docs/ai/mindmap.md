...
![思维导图](../images/img_f78bda21.png) 整个功能，涉及到 2 个表：
...
![AI 思维导图模型](../images/img_1ed43e7a.png) ② 情况二：如果没有配置，那就会使用 `ai_model` 表中的第一个模型（排序 `sort` 最小的）。同时，它对应的 system prompt 在 AiChatRoleEnum 的 `AI_MIND_MAP_ROLE` 进行配置。
## # 2. 思维导图记录表
...
![思维导图](../images/img_f78bda21.png) 它的后端 HTTP 接口，由 `yudao-module-ai` 模块的 `mindmap` 包的 AiMindMapController 实现。
最最最关键的代码！！！大家可以重点看看！！！
...
![思维导图管理](../images/img_c43d855e.png) 
.pageB img{width:80px!important;}
.wwads-horizontal .wwads-text, .wwads-content .wwads-text{line-height:1;}
[AI 写作助手](/ai/write/) [AI 工具（function calling）](/ai/tool/) 
←
[AI 写作助手](/ai/write/) [AI 工具（function calling）](/ai/tool/)→
