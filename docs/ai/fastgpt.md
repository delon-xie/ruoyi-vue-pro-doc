...
## # 2. 如何接入？
由于 FastGPT 的 [对话接口](https://doc.fastgpt.cn/docs/development/openapi/chat/#%E5%8F%91%E8%B5%B7%E5%AF%B9%E8%AF%9D) 兼容了 GPT 的接口，所以可以使用 [《【模型接入】OpenAI》](/ai/openai) 的方式，通过 OpenAIChatModel 进行接入。
