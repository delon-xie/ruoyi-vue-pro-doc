...
![创建密钥](../images/img_fc2599e6.png) ③ 在 [智能广场 -> 模型广场](https://console.volcengine.com/ark/region:ark+cn-beijing/model?vendor=Bytedance&view=LIST_VIEW) 上，选择“Doubao-1.5-lite-32k”模型，进行开通。
