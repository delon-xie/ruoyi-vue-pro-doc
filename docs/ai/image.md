...
![AI 绘画](../images/img_d6149401.png) 整个功能，涉及到 3 个表：
...
- 文心一言的 ernie_Vilg 模型：[《【模型接入】文心一言》](/ai/yiyan)
- 智谱 GLM 的 CogView 模型：[《【模型接入】智谱 GLM》](/ai/glm)
- 硅基流动的图片模型：[《【模型接入】硅基流动》](/ai/siliconflow)
...
![绘画](../images/img_d6149401.png) 它的后端 HTTP 接口，由 `yudao-module-ai` 模块的 `image` 包的 AiImageController 实现。
最最最关键的代码！！！大家可以重点看看！！！
...
![绘画管理](../images/img_c2a7130c.png) 
.pageB img{width:80px!important;}
.wwads-horizontal .wwads-text, .wwads-content .wwads-text{line-height:1;}
[AI 聊天对话](/ai/chat/) [AI 知识库（RAG）](/ai/knowledge/) 
←
[AI 聊天对话](/ai/chat/) [AI 知识库（RAG）](/ai/knowledge/)→
