...
![配送区域](../images/img_14730669.png) ③ `start_count`、`start_price`、`extra_count`、`extra_price` 字段：配送计费的具体配置。
#### # 2.1.3 运费模板【包邮】配置
省略 creator/create_time/updater/update_time/deleted/tenant_id 等通用字段
...
[【交易】售后退款](/mall/trade-aftersale/) [【交易】门店自提](/mall/trade-delivery-pickup/) 
←
[【交易】售后退款](/mall/trade-aftersale/) [【交易】门店自提](/mall/trade-delivery-pickup/)→
