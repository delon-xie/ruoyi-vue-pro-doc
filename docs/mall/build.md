...
![取消 模块的注释](../images/img_1261abff.png) ② 修改 `yudao-server` 目录的 [`pom.xml` (opens new window)](https://github.com/YunaiV/ruoyi-vue-pro/blob/master/yudao-server/pom.xml) 文件，引入 `yudao-module-mall` 模块。如下图所示：
...
注意，微信有各种白名单要配置，可参考 [https://blog.csdn.net/weixin_45966674/article/details/133280890 (opens new window)](https://blog.csdn.net/weixin_45966674/article/details/133280890) 文章。
