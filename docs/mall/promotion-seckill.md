...
![管理后台](../images/img_0c47c06f.png) 
### # 2.3 移动端
① 点击 uni-app 首页的 [秒杀] 菜单，进入秒杀列表页，对应 `pages/activity/seckill/list.vue` 目录。如下图所示：
![秒杀列表](../images/img_dcd98951.png) ② 点击某个秒杀，进入秒杀详情页，对应 `pages/goods/seckill.vue` 目录。如下图所示：
![秒杀详情](../images/img_499c4670.png) ③ 点击「立即购买」按钮，选择商品后，进入确认订单页，如下图所示：
![确认订单](../images/img_800d7a39.png) 点击「提交订单」按钮后，会创建一条 `trade_order` 订单记录：
...
[【营销】拼团活动](/mall/promotion-combination/) [【营销】砍价活动](/mall/promotion-bargain/) 
←
[【营销】拼团活动](/mall/promotion-combination/) [【营销】砍价活动](/mall/promotion-bargain/)→
