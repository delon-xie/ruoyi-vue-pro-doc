...
![流程设计器](../images/img_a864faf1.png) 它是基于 [https://github.com/miyuesc/bpmn-process-designer (opens new window)](https://github.com/miyuesc/bpmn-process-designer) 拓展，底层是 [bpmn-js (opens new window)](https://github.com/bpmn-io)。
补充说明：
...
![流程预览](../images/img_73228adc.png) 它是直接基于 [bpmn-js (opens new window)](https://github.com/bpmn-io) 拓展，没有基于 `bpmn-process-designer`。
...
### # 1.6 任务（自定义配置）
非 BPMN 标准的配置项，由我们自定义实现 [UserTaskCustomConfig.vue (opens new window)](https://github.com/yudaocode/yudao-ui-admin-vue3/blob/master/src/components/bpmnProcessDesigner/package/penal/custom-config/components/UserTaskCustomConfig.vue) ，存储在 BPMN XML 的 `` 节点中。
...
## # 666. 社区贡献相关
- [《Pull Request：BPMN 增加国际化》 (opens new window)](https://github.com/yudaocode/yudao-ui-admin-vue3/pull/150)
