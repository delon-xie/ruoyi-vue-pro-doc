...
![财务管理](../images/img_30045583.png) 友情提示：目前财务相关的功能还做的相对简单，后续会继续增强！！！
...
![采购付款](../images/img_ee281ce9.png) 点击「新增」按钮，随便填写一些信息，点击「确认」按钮，即可新增一条付款单。
![新增采购付款](../images/img_09165cec.png) 友情提示：只有审批通过的采购入库、采购退货单才能进行选择添加。
## # 3. 销售收款
...
![销售收款](../images/img_2afac143.png) 点击「新增」按钮，随便填写一些信息，点击「确认」按钮，即可新增一条收款单。
![新增销售收款](../images/img_92f7469c.png) 友情提示：只有审批通过的销售出库、销售退货单才能进行选择添加。
.pageB img{width:80px!important;}
.wwads-horizontal .wwads-text, .wwads-content .wwads-text{line-height:1;}
[【销售】销售订单、出库、退货](/erp/sale/) [CRM 演示](/crm-preview/) 
←
[【销售】销售订单、出库、退货](/erp/sale/) [CRM 演示](/crm-preview/)→
