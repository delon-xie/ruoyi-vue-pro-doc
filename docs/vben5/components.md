...
- 实战案例（分页列表）： ![实战案例（分页）](../images/table-list.png) antd 版本：[apps/web-antd/src/views/system/user/index.vue](https://github.com/yudaocode/yudao-ui-admin-vben/blob/master/apps/web-antd/src/views/system/user/index.vue)
...
- 源码位置： antd 版本：[apps/web-antd/src/components/table-action](https://github.com/yudaocode/yudao-ui-admin-vben/tree/master/apps/web-antd/src/components/table-action)
...
- 实战案例： ![实战案例](../images/modal-form.png) antd 版本：[apps/web-antd/src/views/system/user/modules/form.vue](https://github.com/yudaocode/yudao-ui-admin-vben/blob/master/apps/web-antd/src/views/system/user/modules/form.vue)
...
- 实战案例： ![实战案例](../images/drawer.png) antd 版本：[web-antd/src/views/ai/chat/index/modules/role/repository.vue](https://github.com/yudaocode/yudao-ui-admin-vben/blob/master/apps/web-antd/src/views/ai/chat/index/modules/role/repository.vue)
...
- 源码位置： antd 版本：[apps/web-antd/src/components/description](https://github.com/yudaocode/yudao-ui-admin-vben/tree/master/apps/web-antd/src/components/description)
...
- 实战案例（ApiSelect）： ![实战案例（ApiSelect）](../images/api-select.png) antd 版本：[apps/web-antd/src/views/system/user/data.ts](https://github.com/yudaocode/yudao-ui-admin-vben/blob/master/apps/web-antd/src/views/system/user/data.ts) 的 `postIds` 字段
...
- 源码位置： antd 版本：[apps/web-antd/src/components/upload](https://github.com/yudaocode/yudao-ui-admin-vben/tree/master/apps/web-antd/src/components/upload)
...
- 源码位置： antd 版本：[apps/web-antd/src/components/tinymce](https://github.com/yudaocode/yudao-ui-admin-vben/tree/master/apps/web-antd/src/components/tinymce)
...
- 实战案例（`confirm` 提示）： ![实战案例（confirm 提示）](../images/alert-confirm.png) antd 版本：[apps/web-antd/src/views/system/user/index.vue](https://github.com/yudaocode/yudao-ui-admin-vben/blob/master/apps/web-antd/src/views/system/user/index.vue) 的 `handleDeleteBatch` 方法
...
用于展示操作日志的组件。
- 源码位置： antd 版本：[apps/web-antd/src/components/operate-log](https://github.com/yudaocode/yudao-ui-admin-vben/tree/master/apps/web-antd/src/components/operate-log)
...
- 实战案例： ![实战案例](../images/echarts-trends.png) antd 版本：[apps/web-antd/src/views/dashboard/analytics/analytics-trends.vue](https://github.com/yudaocode/yudao-ui-admin-vben/blob/master/apps/web-antd/src/views/dashboard/analytics/analytics-trends.vue)
...
- 官方文档：[form-create](http://www.form-create.com/) antd 版本：[apps/web-antd/src/components/form-create](https://github.com/yudaocode/yudao-ui-admin-vben/tree/master/apps/web-antd/src/components/form-create)
...
- 源码位置（流程设计器 MyProcessDesigner）： antd 版本：[apps/web-antd/src/views/bpm/components/bpmn-process-designer/package/designer](https://github.com/yudaocode/yudao-ui-admin-vben/tree/master/apps/web-antd/src/views/bpm/components/bpmn-process-designer/package/designer)
...
- 实战案例（AnalysisOverview 组件，内部使用 CountToAnimator））： ![实战案例（AnalysisOverview 组件）](../images/count-to-animator.png) antd 版本：[apps/web-antd/src/views/dashboard/analytics/index.vue](https://github.com/yudaocode/yudao-ui-admin-vben/blob/master/apps/web-antd/src/views/dashboard/analytics/index.vue)
...
Markdown 内容预览组件。
- 源码位置： antd 版本：[apps/web-antd/src/components/markdown-view](https://github.com/yudaocode/yudao-ui-admin-vben/tree/master/apps/web-antd/src/components/markdown-view)
...
- 源码位置： antd 版本：[apps/web-antd/src/components/shortcut-date-range-picker](https://github.com/yudaocode/yudao-ui-admin-vben/tree/master/apps/web-antd/src/components/shortcut-date-range-picker)
...
Cron 表达式可视化编辑组件。
- 源码位置： antd 版本：[apps/web-antd/src/components/cron-tab](https://github.com/yudaocode/yudao-ui-admin-vben/tree/master/apps/web-antd/src/components/cron-tab)
...
### # 2.6 Cropper 图片裁剪
图片裁剪组件，支持旋转、缩放等操作。
- 源码位置： antd 版本：[apps/web-antd/src/components/cropper](https://github.com/yudaocode/yudao-ui-admin-vben/tree/master/apps/web-antd/src/components/cropper)
...
- 实战案例（代码生成器预览）： ![实战案例（代码生成器预览）](../images/code-editor.png) antd 版本：[apps/web-antd/src/views/infra/codegen/modules/preview-code.vue](https://github.com/yudaocode/yudao-ui-admin-vben/blob/master/apps/web-antd/src/views/infra/codegen/modules/preview-code.vue)
...
- 实战案例（AI 思维导图）： ![实战案例（AI 思维导图）](../images/markmap-mindmap.png) antd 版本：[apps/web-antd/src/views/ai/mindmap/index/modules/right.vue](https://github.com/yudaocode/yudao-ui-admin-vben/blob/master/apps/web-antd/src/views/ai/mindmap/index/modules/right.vue)
...
- 实战案例（登录页验证码，使用 Verification 组件）： ![实战案例（登录页验证码）](../images/captcha-login.png) antd 版本：[apps/web-antd/src/views/_core/authentication/login.vue](https://github.com/yudaocode/yudao-ui-admin-vben/blob/master/apps/web-antd/src/views/_core/authentication/login.vue)
