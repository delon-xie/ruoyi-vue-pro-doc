...
![表关系](../images/img_0b2f6003.png) 它的整体流程，如下图所示：
![整体流程](../images/img_ee2a9704.png) 
## # 1. 客户
...
![销售订单](../images/img_bf5d89e9.png) ① 点击「新增」按钮，随便填写一些信息，点击「确认」按钮，即可新增一条销售订单。
![新增销售订单](../images/img_2b490175.png) ② 点击该销售订单的「审批」按钮，审批通过该销售订单，此时状态会变成“已审批”，但是并不会影响库存。
## # 3. 销售出库
...
![销售出库](../images/img_e678b7f9.png) ① 点击「新增」按钮，随便填写一些信息，点击「确认」按钮，即可新增一条销售出库。
![新增销售出库](../images/img_43fb325a.png) ② 点击该销售出库的「审批」按钮，审批通过该销售出库，此时状态会变成“已审批”，同时会减少对应的库存、新增库存明细。如下图所示：
![审批销售出库](../images/img_32b9cb56.png) ③ 点击该销售出库的「反审批」按钮，反审批该销售出库，此时状态会变成“未审批”，同时会增加对应的库存、新增库存明细。如下图所示：
![反审批销售出库](../images/img_8e6564bc.png) 
## # 4. 销售退货
...
![销售退货](../images/img_95fb42b8.png) ① 点击「新增」按钮，随便填写一些信息，点击「确认」按钮，即可新增一条销售退货。
![新增销售退货](../images/img_fd1670e4.png) ② 点击该销售退货的「审批」按钮，审批通过该销售退货，此时状态会变成“已审批”，同时会增加对应的库存、新增库存明细。如下图所示：
![审批销售退货](../images/img_c3cfc566.png) ③ 点击该销售退货的「反审批」按钮，反审批该销售退货，此时状态会变成“未审批”，同时会减少对应的库存、新增库存明细。如下图所示：
![反审批销售退货](../images/img_897b6adc.png) 
## # 5. 销售收款
参见 [《【财务】采购付款、销售收款》](/erp/finance-payment-receipt/) 文档。
.pageB img{width:80px!important;}
.wwads-horizontal .wwads-text, .wwads-content .wwads-text{line-height:1;}
[【采购】采购订单、入库、退货](/erp/purchase/) [【财务】采购付款、销售收款](/sale/finance-payment-receipt/) 
←
[【采购】采购订单、入库、退货](/erp/purchase/) [【财务】采购付款、销售收款](/sale/finance-payment-receipt/)→
