...
![管理后台 - 其它入库](../images/img_db99ef94.png) ① 点击「新增」按钮，随便填写一些信息，点击「确认」按钮，即可新增一条其它入库单。
![新增其它入库](../images/img_36b90340.png) ② 点击该入库单的「审批」按钮，审批通过该入库单，此时状态会变成“已审批”，同时增加对应的库存、新增库存明细。如下图所示：
![审批其它入库](../images/img_3c4fc02b.png) ③ 点击该入库单的「反审批」按钮，反审批该入库单，此时状态会变成“未审批”，同时减少对应的库存、新增库存明细。如下图所示：
![反审批其它入库](../images/img_a399b20f.png) 
## # 2. 其它出库
...
![管理后台 - 其它出库](../images/img_bed4839d.png) ① 点击「新增」按钮，随便填写一些信息，点击「确认」按钮，即可新增一条其它出库单。
![新增其它出库](../images/img_073df03f.png) ② 点击该出库单的「审批」按钮，审批通过该出库单，此时状态会变成“已审批”，同时减少对应的库存、新增库存明细。如下图所示：
![审批其它出库](../images/img_c5284804.png) ③ 点击该出库单的「反审批」按钮，反审批该出库单，此时状态会变成“未审批”，同时增加对应的库存、新增库存明细。如下图所示：
![反审批其它出库](../images/img_19c98d1a.png) 
.pageB img{width:80px!important;}
.wwads-horizontal .wwads-text, .wwads-content .wwads-text{line-height:1;}
[【库存】产品库存、库存明细](/erp/stock/) [【库存】库存调拨、库存盘点](/erp/stock-move-check/) 
←
[【库存】产品库存、库存明细](/erp/stock/) [【库存】库存调拨、库存盘点](/erp/stock-move-check/)→
