...
![基础设施 -> 数据库文档](/images/01.png) 关于 Screw 的使用讲解，可见 [《芋道 Spring Boot 数据表结构文档 》 (opens new window)](https://www.iocoder.cn/Spring-Boot/DB-Doc-screw/?yudao) 文章。
.pageB img{width:80px!important;}
.wwads-horizontal .wwads-text, .wwads-content .wwads-text{line-height:1;}
[配置管理](/config-center/) [定时任务](/job/) 
←
[配置管理](/config-center/) [定时任务](/job/)→
