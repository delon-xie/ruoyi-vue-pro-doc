...
![钱包支付](../images/img_f1a13a98.png) 
### # 3.1 钱包支付
在商城 uni-app 收银台，选择“余额支付”时，内部会调用 WalletPayClient 的 `#doUnifiedOrder(...)` 方法，发起支付。
![钱包支付2](../images/img_498d9b95.png) 它的整体流程和 [《支付宝支付接入》](/pay/alipay-pay-demo) 是一致的。
### # 3.2 钱包退款
...
[微信转账接入](/pay/wx-transfer-demo/) [模拟支付、退款](/pay/mock/) 
←
[微信转账接入](/pay/wx-transfer-demo/) [模拟支付、退款](/pay/mock/)→
