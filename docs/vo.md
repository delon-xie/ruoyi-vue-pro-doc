...
![简单场景](/images/BeanUtils-01.png) 2、在复杂场景，可以通过 Consumer 进一步拼接，如下图所示：
图片纠错：最新版本不区分 yudao-module-erp-api 和 yudao-module-erp-biz 子模块，代码直接合并到 yudao-module-erp 模块的 src 目录下，更适合单体项目
![复杂场景](/images/BeanUtils-02.png) 当然，如果 Consumer 的逻辑比较复杂，又希望 Controller 代码精简一点，可以放到对应的 Convert 类里，如下图所示：
![更复杂场景](/images/BeanUtils-03.png) 
## # 2. 数据翻译
