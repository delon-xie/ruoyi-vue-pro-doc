...
友情提示：其它 SVG 图标网站也可以。
![下载 SVG 格式](../images/02.png) ② 将 SVG 图标添加到 [`@/icons/svg` (opens new window)](https://github.com/yudaocode/yudao-ui-admin-vue2/tree/master/src/assets/icons/svg) 目录下，然后进行使用。
## # 3. 改变颜色
