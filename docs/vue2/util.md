...
② 修改页签 const obj = Object.assign({}, this.$route, { title: "自定义标题" })
this.$tab.updatePage(obj);
this.$tab.updatePage(obj).then(() => {
// 执行结束的逻辑
})
③ 关闭页签 // 关闭当前 tab 页签，打开新页签
...
[系统组件](/vue2/components/) [配置读取](/vue2/config-center/) 
←
[系统组件](/vue2/components/) [配置读取](/vue2/config-center/)→
