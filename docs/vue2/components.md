...
![表单设计组件](../images/05.png) ② 表单展示组件 [`parser`](https://github.com/yudaocode/yudao-ui-admin-vue2/blob/master/src/components/parser/Parser.vue)，基于 [`form-generator`](https://github.com/JakHuang/form-generator) 封装。
...
![工作流设计组件](../images/07.png) ② 工作流展示组件 [`my-process-viewer`](https://github.com/yudaocode/yudao-ui-admin-vue2/blob/master/src/components/bpmnProcessDesigner/package/designer/ProcessViewer.vue)，在 [`bpm/model/modelEditor.vue`](https://github.com/yudaocode/yudao-ui-admin-vue2/blob/master/src/views/bpm/processInstance/detail.vue#L84-L85) 中使用案例：
