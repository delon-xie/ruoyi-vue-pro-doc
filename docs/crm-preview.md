...
## # 3. CRM 交流
专属交流社区，欢迎扫码加入。
![交流群](/images/zsxq_crm.png) 
## # 4. 功能描述
主要分为 6 个核心模块：线索、客户、商机、合同、回款、产品。
![ERP 功能列表](/images/crm-feature.png) 
## # 5. 表结构
