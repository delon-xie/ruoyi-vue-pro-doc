...
![IDEA 配置热加载](/images/img_7ecef3ab.png) ② Debug 运行该启动类，等待项目启动完成。
...
![IDEA 代码热加载](/images/img_92818692.png) 
### # 2.2 存在问题
...
如果 GUID 过期，可以试试 [https://www.guidgen.com/ (opens new window)](https://www.guidgen.com/) 去生成！！！
...
![JRebel 下载](/images/img_55e664fd.png) ② 打开 [Preference -> Plugins] 菜单，点击「Install Plugin from Disk...」按钮，选择刚下载的 JRebel 插件的压缩包。如下图所示：
![JRebel 安装](/images/img_1bef8a72.png) 安装完成后，需要重启 IDEA 生效。
...
![JRebel 激活](/images/img_6546bca6.png) 之后，点击「Work Offline」按钮，设置 JRebel 为离线，避免因为网络问题导致激活失效。如下图所示：
![JRebel 离线](/images/img_0ba09227.png) 
### # 3.2 如何使用
① 点击「Debug With JRebel」按钮，使用 JRebel 启动项目。如下图所示：
图片纠错：最新版本不区分 yudao-module-system-api 和 yudao-module-system-biz 子模块，代码直接合并到 yudao-module-system 模块的 src 目录下，更适合单体项目
![JRebel 启动项目](/images/img_6399d1fe.png) ② 每次修改 Java 代码后，点击左下角的「热加载」按钮，即可实现代码热加载。如下图所示：
图片纠错：最新版本不区分 yudao-module-system-api 和 yudao-module-system-biz 子模块，代码直接合并到 yudao-module-system 模块的 src 目录下，更适合单体项目
![JRebel 代码热加载](/images/img_de97519c.png) 
### # 3.3 补充说明
① mybatis plus 如何热部署？
需要安装 [https://plugins.jetbrains.com/plugin/12682-jrebel-mybatisplus-extension (opens new window)](https://plugins.jetbrains.com/plugin/12682-jrebel-mybatisplus-extension) 插件。
.pageB img{width:80px!important;}
.wwads-horizontal .wwads-text, .wwads-content .wwads-text{line-height:1;}
[项目结构](/project-intro/) [一键改包](/project-rename/) 
←
[项目结构](/project-intro/) [一键改包](/project-rename/)→
